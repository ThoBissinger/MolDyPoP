function calculate_jackknife_Smperp(infile_base) %, system, L)
% FUNCTION CALCULATE_JACKKNIFE_SMPERP calculates jackknife distribution of
% the Fourier transform of C_mperpmperp(q,t). Also calculates the FWHM and
% fits the coefficients gamma and omega_0 based on the coefficients fitted
% in the time domain.
    ...
    outfile=sprintf('%s_jackknife_Smperp.mat',infile_base);
